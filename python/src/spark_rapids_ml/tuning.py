...
from typing import Callable, List, Sequence, Tuple, cast, TYPE_CHECKING
...
from spark_rapids_ml.classification import RandomForestClassificationModel
...
class CrossValidator(SparkCrossValidator):
    # TODO to be compatible with older pyspark
